...
``Out of scope:`` prefix. In practice the validator would have raised before we
got here, so this filter mostly handles edge cases at the boundary
(``confidence_pct == 30`` exactly, or a future loosening of the threshold).
"""
